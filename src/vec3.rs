...
impl ops::Add<Vec3> for Vec3{
    ...
    fn add(self, rhs: Vec3) -> Self::Output {
        return Vec3{e: [self.e[0] + rhs.e[0], self.e[1] + rhs.e[1], self.e[2] + rhs.e[2]]};
    }
}
...
impl ops::Div<f64> for Vec3{
    ...
    fn div(self, rhs: f64) -> Self::Output {
        return Vec3{e: [self.e[0] / rhs, self.e[1] / rhs, self.e[2] / rhs]};
    }
}
...
fn random(min: f64, max: f64) -> Vec3{
    return Vec3{e: [random_double(min, max), random_double(min, max), random_double(min, max)]}
}
